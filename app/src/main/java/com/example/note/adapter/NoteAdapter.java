...
public class NoteAdapter extends BaseAdapter implements Filterable{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = View.inflate(mContext, R.layout.note_layout, null); //加载布局文件
        ...
        tv_time.setText(noteList.get(position).getTime());  //将集合数据加载到控件中

        //Save note id to long
        v.setTag(noteList.get(position).getId()); //设置一个条目的ID
